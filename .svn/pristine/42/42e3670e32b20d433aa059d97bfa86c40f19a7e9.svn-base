...
/**
 * The persistent class for the REPORT_PAYABLE_TAX_LAND database table.
 * 
 */
@Entity
@Table(name = "REPORT_PAYABLE_TAX_LAND")
public class ReportPayableTaxLand extends com.wcs.base.model.IdEntity implements Serializable {
    ...
    private double yearAccumDeclare;
    ...
    public double getCurrDeclare() {
        return this.currDeclare;
    }

    public void setCurrDeclare(double currDeclare) {
    ...
    public double getYearAccumDeclare() {
        return this.yearAccumDeclare;
    }

    public void setYearAccumDeclare(double yearAccumDeclare) {
