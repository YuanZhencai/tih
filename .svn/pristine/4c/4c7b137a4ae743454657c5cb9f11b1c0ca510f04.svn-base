package com.wcs.scheduler.util;
...
public final class DateUtils {
    ...
    public static String format(Date date) {
        if (date == null) return "";
        else return getFormatter(YYYY_MM_DD).format(date);
    }
    ...
    public static long getTodayIntevalDays(String startDate) {
        try {
            ...
            // 当前时间
        	java.util.Date currentDate = myFormatter.parse(format(new Date()));
            // 指定日期
    ...
    public static void main(String[] args) {
        try {
            ...
            Date date = DateUtils.parse("2014", "yyyy-01-01");
