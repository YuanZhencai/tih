...
/**
 * The persistent class for the INVS_INSPECTATION_RESULT_HISTORY database table.
 * 
 */
@Entity
@Table(name="INVS_INSPECTATION_RESULT_HISTORY")
public class InvsInspectationResultHistory extends com.wcs.base.model.IdEntity implements Serializable {
	...
	@JoinColumn(name="INVS_INSPECTATION_HISTORY_ID")
	private InvsInspectationHistory invsInspectationHistory;

    public InvsInspectationResultHistory() {
    }
	...
	public InvsInspectationHistory getInvsInspectationHistory() {
		return this.invsInspectationHistory;
	}

	public void setInvsInspectationHistory(InvsInspectationHistory invsInspectationHistory) {
		this.invsInspectationHistory = invsInspectationHistory;
	}
