...
public class NotificationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            String news = "";
            List<NoticeVo> nrList = homePageService.loadNotices("Y");
            if (nrList.size() != 0) {
                for (NoticeVo nv : nrList) {
                    news += "<a href='http://www.chinahtml.com' target='_blank'>" + nv.getTitle() + "</a> <br />";
                }
            }
            ...
            String str = "<DIV style='BORDER-RIGHT: #455690 1px solid; BORDER-TOP: #a6b4cf 1px solid; Z-INDEX: 99999; LEFT: 0px; BORDER-LEFT: #a6b4cf 1px solid; WIDTH: " + "221px; BORDER-BOTTOM: #455690 1px solid; POSITION: absolute; TOP: 0px; HEIGHT: " + "155px; BACKGROUND-COLOR: #c9d3f3'>";
            ...
            str += "<DIV style='WORD-BREAK: break-all' align=left>" + news + "</DIV>";
            str += "</DIV>";
            str += "</TD></TR></TABLE></DIV>";
