...
public class DateUtil {
    ...
    public static DateTime getNowDate() {
        ...
        DateTime result = formatter.parseDateTime(getNowStringDate());
        return result;
    }
    ...
    public static DateTime getNowDateShort() {
        ...
        DateTime result = formatter.parseDateTime(getNowStringDateShort());
        return result;
    }
    ...
    public static void plusDate() {
        ...
        System.out.println("plusDays" + result.toString());
        result = dateDate.plusHours(-9);
        System.out.println("plusHours" + result.toString());
        result = dateDate.plusMinutes(-9);
        System.out.println("plusMinutes" + result.toString());
        result = dateDate.plusMonths(-9);
        System.out.println("plusMonths" + result.toString());
        result = dateDate.plusWeeks(-9);
        System.out.println("plusWeeks" + result.toString());
        ...
        System.out.println("计算五年后的第二个月的最后一天" + result.toString());

        DateTime dt2 = new DateTime();
        DateTime year2000 = dt2.withYear(2000);
        DateTime twoHoursLater = year2000.plusHours(2);
        System.out.println("2000年的现在两小时后" + twoHoursLater.toString(DateTimeFormat.forPattern("yy-MM-dd HH:mm:ss")));
    ...
    public static void compareDate() {
        ...
        System.out.println("日期比较" + d.getDays());

        Months m = Months.monthsBetween(dd, dt);
        System.out.println("月份比较" + m.getMonths());

        Years y = Years.yearsBetween(dd, dt);
        System.out.println("年份比较" + y.getYears());
    }
    ...
    public static void localDate() {
        ...
        System.out.println("本地日期" + localDate.toString());
        System.out.println("本地时间" + localTime.toString());
    ...
    public static void modifyTimeZone() {
        ...
        System.out.println("伦敦时间" + dtLondon.toString());
    }
    ...
    public static void modifyChronology() {
        ...
        System.out.println("年历" + dt.toString());
    }
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            /*------------当前时间函数 --------------*/
            System.out.println(getNowStringDate());
            /*------------时间转换函数 --------------*/
            System.out.println(strToDateShort("2010-10-01"));
            /*------------时间计算函数 --------------*/
            plusDate();
            /*------------时间比较函数 --------------*/
            compareDate();
            ...
            System.out.println(DateTime.parse(test).plusDays(1));
            System.out.println(DateTime.parse(test).getDayOfMonth());
