...
public class UserBean {
    ...
    public void saveUpdateUser() {
        ...
        if (null != userVo.getBirthday()) {
            ...
            if (null != userVo.getWorkDateTime()) {
                num = DateUtil.daysOfTwo(userVo.getBirthday(), userVo.getWorkDateTime());
                if (num < 0) {
                    context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "失败", "入职日期不能小于出生日期，请重新选择日期"));
                    return;
                }
            }
        }
        ...
        if ("insert".equals(excuteMethod)) {
            try {
                ...
                context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "成功", "添加帐号：" + userVo.getUserName() + "，姓名：" + userVo.getRealName() + "，员工号：" + userVo.getJobNumber() + "，用户信息成功，请查询并确认！"));
            } catch (Exception e) {
            ...
            try {
                ...
                RequestContext.getCurrentInstance().addCallbackParam(ISSUCC, "yes");
                context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "成功", "更新帐号：" + userVo.getUserName() + "，姓名：" + userVo.getRealName() + "，员工号：" + userVo.getJobNumber() + "，用户信息成功，请查询并确认！"));
                queryUser();
            } catch (Exception e) {
                context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "失败", e.getMessage()));
                return;
    ...
    public void saveUserPosition() {
        ...
        try {
            ...
            RequestContext.getCurrentInstance().addCallbackParam(ISSUCC, "yes");
            context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "成功", "用户帐号：" + usermstr.getAdAccount() + "，姓名：" + p.getNachn() + "，员工号：" + usermstr.getPernr() + "，分配岗位成功，请查询并确认！"));
        } catch (Exception e) {
            context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "失败", e.getMessage()));
        }
    }
    ...
    public void saveUserRole() {
        ...
        try {
            ...
            RequestContext.getCurrentInstance().addCallbackParam(ISSUCC, "yes");
            context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "成功", "用户帐号：" + usermstr.getAdAccount() + "，姓名：" + p.getNachn() + "，员工号：" + usermstr.getPernr() + "，分配角色成功，请查询并确认！"));
        } catch (Exception e) {
            context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "失败", e.getMessage()));
        }
    }
