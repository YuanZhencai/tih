...
public class UserService {
    ...
    public void saveUser(UsermstrVo userVo) {
    	Usermstr user = userVo.getUsermstr();
    	if (user.getId() == null) {
    		createUser(userVo);
    	} else {
    		updateUser(userVo);
    ...
    public void createUser (UsermstrVo userVo) {
    	...
    	entityService.create(usermstr);
    	entityService.create(p);
    	entityService.create(cup);
    	
		roleAndUserToTdsService.synchronousUserToTds("insert", getUserVoBy(userVo));
    }
    
    public UserVo getUserVoBy(UsermstrVo usermstrVo) {
    	Usermstr usermstr = usermstrVo.getUsermstr();
    	P p = usermstrVo.getP();
    ...
    public void updateUser (UsermstrVo userVo) {
    	String userName = loginService.getCurrentUserName();
    	Date date = new Date();
    	Usermstr usermstr = userVo.getUsermstr();
    	O o = userVo.getO();
    	...
    	entityService.update(cup);
    	roleAndUserToTdsService.synchronousUserToTds("update", getUserVoBy(userVo));
