...
/**
 * The persistent class for the INVS_ANTI_AVOIDANCE database table.
 * 
 */
@Entity
@Table(name="INVS_ANTI_AVOIDANCE")
public class InvsAntiAvoidance extends com.wcs.base.model.IdEntity implements Serializable {
	...
	@OneToMany(mappedBy="invsAntiAvoidance")
	private List<InvsAntiAvoidanceHistory> invsAntiAvoidanceHistories;

	//bi-directional many-to-one association to InvsAntiResult
	@OneToMany(mappedBy="invsAntiAvoidance")
	private List<InvsAntiResult> invsAntiResults;

    public InvsAntiAvoidance() {
    }
	...
	public List<InvsAntiAvoidanceHistory> getInvsAntiAvoidanceHistories() {
		return this.invsAntiAvoidanceHistories;
	}

	public void setInvsAntiAvoidanceHistories(List<InvsAntiAvoidanceHistory> invsAntiAvoidanceHistories) {
		this.invsAntiAvoidanceHistories = invsAntiAvoidanceHistories;
	}
	
	public List<InvsAntiResult> getInvsAntiResults() {
		return this.invsAntiResults;
	}

	public void setInvsAntiResults(List<InvsAntiResult> invsAntiResults) {
		this.invsAntiResults = invsAntiResults;
	}
