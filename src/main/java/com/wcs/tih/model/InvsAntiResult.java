...
/**
 * The persistent class for the INVS_ANTI_RESULT database table.
 * 
 */
@Entity
@Table(name="INVS_ANTI_RESULT")
public class InvsAntiResult extends com.wcs.base.model.IdEntity implements Serializable {
