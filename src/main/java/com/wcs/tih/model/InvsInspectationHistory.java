...
/**
 * The persistent class for the INVS_INSPECTATION_HISTORY database table.
 * 
 */
@Entity
@Table(name="INVS_INSPECTATION_HISTORY")
public class InvsInspectationHistory extends com.wcs.base.model.IdEntity implements Serializable {
	...
	//bi-directional many-to-one association to InvsInspectationResultHistory
	@OneToMany(mappedBy="invsInspectationHistory")
	private List<InvsInspectationResultHistory> invsInspectationResultHistories;

    public InvsInspectationHistory() {
    }
	...
	public List<InvsInspectationResultHistory> getInvsInspectationResultHistories() {
		return this.invsInspectationResultHistories;
	}

	public void setInvsInspectationResultHistories(List<InvsInspectationResultHistory> invsInspectationResultHistories) {
		this.invsInspectationResultHistories = invsInspectationResultHistories;
	}
