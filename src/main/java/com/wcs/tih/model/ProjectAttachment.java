...
/**
 * The persistent class for the PROJECT_ATTACHMENT database table.
 * 
 */
@Entity
@Table(name="PROJECT_ATTACHMENT")
public class ProjectAttachment extends com.wcs.base.model.IdEntity implements Serializable {
