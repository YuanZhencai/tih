...
public class CompanyTaxRatioVo extends IdModel implements Serializable {
	...
	public int getSummeryAnnual() {
		return summeryAnnual;
	}

	public void setSummeryAnnual(int summeryAnnual) {
		this.summeryAnnual = summeryAnnual;
	}
